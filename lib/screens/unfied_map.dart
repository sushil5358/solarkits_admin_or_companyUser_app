...
import '../constants.dart';
import '../controller/unified_map_controller.dart';
...
class _UnifiedSurveyScreenState extends State<UnifiedSurveyScreen> {
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                top: 10,
                left: 10,
                child: Obx(() => controller.isEditingTerraceLayout.value && controller.isEditingWalkway.value
          ...
          child: Column(
            ...
            children: [
              ...
              if (controller.currentMode.value == 1) ...[
                ...
                DropdownButtonFormField<int>(
                  decoration: const InputDecoration(labelText: "Rows per Table", border: OutlineInputBorder(), contentPadding: EdgeInsets.symmetric(horizontal: 8, vertical: 4)),
  ...
  Widget _buildWalkwayEditCard() {
    if (controller.selectedWalkwayIndex.value < 0 ||
        controller.selectedWalkwayIndex.value >= controller.currentWalkways.length) {
      return const SizedBox();
    }
