// lib/screens/edit_quote_screen.dart
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';

class EditquoteCompanyuser extends StatefulWidget {
  int? margin;
   EditquoteCompanyuser({super.key,required this.margin});

  @override
  State<EditquoteCompanyuser> createState() => _EditQuoteScreenState();
}

class _EditQuoteScreenState extends State<EditquoteCompanyuser> {
  // Controllers with pre-filled values
  final TextEditingController _customerNameController = TextEditingController(text: 'Rahul Sharma');
  final TextEditingController _customerNumberController = TextEditingController(text: '+91 98765 43210');
  final TextEditingController _structureInstallationController = TextEditingController(text: '25000');
  final TextEditingController _installationController = TextEditingController(text: '15000');
  final TextEditingController _remarkController = TextEditingController(text: 'Customer requested early delivery');
  final TextEditingController _marginController = TextEditingController(text: '5000');
  final TextEditingController _companyMarginController = TextEditingController(text: '3000');
  final TextEditingController _discountController = TextEditingController(text: '2000');
  final TextEditingController _dateController = TextEditingController(text: DateFormat('dd-MM-yyyy').format(DateTime.now().add(const Duration(days: 5))));

  // Dropdown selections with pre-filled values
  String? _selectedProjectType = '1';
  String? _selectedTechnology = '1';
  String? _selectedPanelWatt = '1';
  String? _selectedNumberOfPanels = '24';
  String? _selectedKW = '2';
  String? _selectedCombo = '2';
  String? _selectedSolarPanel = '1';
  String? _selectedInverter = '2';
  String? _selectedBosKit = '1';
  String? _selectedTerraceType = '1';
  String? _selectedFileType = 'Loan';
  String? _selectedLoanType = 'NBFC';
  String? _selectedCategory = 'Solar rooftop';
  String? _selectedSubCategory = 'Residencial';
  String? _selectedSubProjectType = 'On Grid';
  ...
  bool _showChannelPartnerCharges = true;
  ...
  String _selectedTimeSlot = '10 AM - 12 PM';
        ...
        child: Column(
          ...
          children: [
            ...
            _buildDropdownField(
              ...
              onChanged: (value) => setState(() => _selectedSubProjectType = value),
            ),
            const SizedBox(height: 15),
              ...
              content: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        _buildSummaryRow('Sub Total:', '₹6,50,000'),
                        _buildSummaryRow('GST (18%):', '₹1,17,000'),
                        _buildSummaryRow('Round Off:', '0'),
                        const Divider(),
                        _buildSummaryRow('Grand Total:', '₹7,67,000', isBold: true),
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                child: const Text('Update Quote', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
              ),
            ),
          ],
        ),
            ...
            content: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 15),
                  const Text('Choose Date', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500)),
                  const SizedBox(height: 5),
                  TextFormField(
                  ...
                  const SizedBox(height: 15),
                  const Text('Choose Time', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500)),
                  const SizedBox(height: 10),
                  SizedBox(
                    height: 120,
                      ...
                      itemBuilder: (context, index) {
                        return GestureDetector(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              border: Border.all(
                                color: _selectedTimeSlot == timeSlots[index] ? Colors.green : Colors.grey.shade300,
                              ),
                              borderRadius: BorderRadius.circular(8),
                              color: _selectedTimeSlot == timeSlots[index] ? Colors.green.shade50 : Colors.white,
                            ),
                            child: Center(
                              child: Text(
                                timeSlots[index],
                                ...
                                style: TextStyle(
                                  fontSize: 11,
                                  color: _selectedTimeSlot == timeSlots[index] ? Colors.green : Colors.grey.shade700,
                                ),
                              ),
                            ),
                          ),
                  ...
                  const SizedBox(height: 15),
                  const Text('Remark', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500)),
                  const SizedBox(height: 5),
                  TextFormField(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text('Quote updated successfully!'), backgroundColor: Colors.green),
                        );
                      },
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.green,
  ...
  void _showKitTypeDialog() {
    ...
    String localFileType = _selectedFileType ?? 'Cash';
    String localLoanType = _selectedLoanType ?? 'NBFC';
