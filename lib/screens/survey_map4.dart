...
import '../controller/survey_map_controller4.dart';
...
class SurveyMap4 extends StatefulWidget {

  SurveyMap4({super.key});

  @override
  State<SurveyMap4> createState() => _SurveyMap4State();
}




class _SurveyMap4State extends State<SurveyMap4> {

  final SurveyMapController4 controller = Get.put(SurveyMapController4());
          ...
          Row(
            ...
            children: [
              FloatingActionButton(
                ...
                child: Image.asset("assets/whatsapp_icon.png", width: 40),
              ),
              controller.showStreetView.value
                  ? const SizedBox()
                  : FloatingActionButton(
  ...
  Widget _buildExistingTerraceCard(Terrace terrace, int indexx) {
    final controller = Get.find<SurveyMapController4>();
