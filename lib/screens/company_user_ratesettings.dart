...
class companyUserRatesettings extends StatefulWidget {


  const companyUserRatesettings({super.key});

  @override
  State<companyUserRatesettings> createState() => _companyUserRatesettingsState();
}

class _companyUserRatesettingsState extends State<companyUserRatesettings> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Company User Settings'),
        centerTitle: true,
      ),
          ...
          children: [
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return InkWell(
                  onTap:  () {
                    Get.to(()=>ProjecttypeRatesettings(margin: '0',));
                  },
                  child: Container(
