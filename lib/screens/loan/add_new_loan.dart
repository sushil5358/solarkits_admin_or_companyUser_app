...
//
//   @override
//   State<AddNewLoan> createState() => _AddQuoteScreenState();
// }
//
// class _AddQuoteScreenState extends State<AddNewLoan> {
//   // Controllers
...
//                 ),
//                 child: const Text('Save & Next', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
//               ),
//             ),
//           ],
//         ),
...
class AddLoanQuote extends StatefulWidget {
  const AddLoanQuote({super.key});

  @override
  State<AddLoanQuote> createState() => _AddQuoteScreenState();
}

class _AddQuoteScreenState extends State<AddLoanQuote> {
  // Controllers
  final TextEditingController _customerNameController = TextEditingController();
  final TextEditingController _customerNumberController = TextEditingController();
  ...
  final List<Map<String, dynamic>> cities = [
    {'id': '1', 'name': 'Ahmedabad City', 'districtId': '1'},
    {'id': '2', 'name': 'Gandhinagar City', 'districtId': '1'},
    {'id': '3', 'name': 'Surat City', 'districtId': '2'},
    {'id': '4', 'name': 'Vadodara City', 'districtId': '3'},
    {'id': '5', 'name': 'Rajkot City', 'districtId': '4'},
    {'id': '6', 'name': 'Bhavnagar City', 'districtId': '5'},
  ];

  List<Map<String, dynamic>> get filteredCities {
    if (_selectedDistrict == null) return [];
    return cities.where((city) => city['districtId'] == _selectedDistrict).toList();
  }
